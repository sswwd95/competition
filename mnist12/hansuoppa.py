...
file_path = '../dacon12/dirty_mnist_2nd/00000.png'
...
for i in range(len(contours)):
    cv2.drawContours(edged, [contours[i]], 0, (255, 0, 0), 2)
   #cv2.drawContours(이미지, [윤곽선], 윤곽선 인덱스, (B, G, R), 두께, 선형 타입)
    cv2.putText(edged, str(i), tuple(contours[i][0][0]), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 0, 0), 1)
