...
# TPS Apr 2021 pseudo labeling/voting ensemble
import pandas as pd
import numpy as np
import random
import os
...
train_df = pd.read_csv("A:\\study\\data\\titanic\\train.csv")
test_df = pd.read_csv("A:\\study\\data\\titanic\\test.csv")
submission = pd.read_csv("A:\\study\\data\\titanic\\sample_submission.csv")
test_df[TARGET] = pd.read_csv("A:\\study\\data\\titanic\\pseudo_label.csv")[TARGET]
...
classifier = XGBClassifier(n_estimators=1000) # , device = 'gpu', LGBMClassifier
...
submission['submit_2'] = pd.read_csv("A:\\study\\data\\titanic\\dae.csv")[TARGET]
submission['submit_3'] = pd.read_csv("A:\\study\\data\\titanic\\pseudo_label.csv")[TARGET]
