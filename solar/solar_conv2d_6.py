...
x_train = x_train.reshape(int(x_train.shape[0]/48),1,48,x_train.shape[1])
x_test = x_test.reshape(int(x_test.shape[0]/48),1,48,x_test.shape[1])
x_val = x_val.reshape(int(x_val.shape[0]/48),1,48,x_val.shape[1])
...
sub.to_csv('./solar/csv/sub_conv2d_6.csv',index=False)
